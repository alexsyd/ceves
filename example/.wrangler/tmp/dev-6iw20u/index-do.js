...
// .wrangler/tmp/bundle-Snp7s5/strip-cf-connecting-ip-header.js
  ...
  async fetch(request) {
    try {
      ...
      if (request.method !== "GET" && request.method !== "HEAD") {
        ...
        if (command.commandType && command.payload !== void 0) {
...
// .wrangler/tmp/bundle-Snp7s5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Snp7s5/middleware-loader.entry.ts
